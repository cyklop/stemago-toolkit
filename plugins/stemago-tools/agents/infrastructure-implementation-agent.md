...
tools: Read, Write, Edit, MultiEdit, Bash, Glob, Grep, mcp__beads__show, mcp__beads__update, LS, mcp__context7__resolve-library-id, mcp__context7__get-library-docs
color: orange
---
...
**Before implementing, I check Beads task for research context and use Context7 for current documentation:**

```javascript
// 1. Get Beads research context
