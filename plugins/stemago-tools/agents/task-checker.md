...
tools: mcp__beads__show, mcp__beads__update, mcp__beads__list, mcp__beads__close, mcp__beads__blocked, mcp__context7__resolve_library_id, mcp__context7__get_library_docs, Read, Bash(npm test:*), Bash(npm run lint:*), Bash(npm run build:*), Grep, LS, Task
model: sonnet
color: yellow
---
...
1. **Task Specification Review**
   - Retrieve task details using MCP tool `mcp__beads__show`
...
1. **Retrieve Task Information**
   ```
   Use mcp__beads__show to get full task details
...
- `mcp__beads__show`: Get task details
