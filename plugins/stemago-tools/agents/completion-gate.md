...
tools: Read, mcp__beads__show, Grep, LS, Bash
color: purple
---
...
- **Task Analysis**: Get Beads task details and extract acceptance criteria
...
1. **Task Analysis**: Use mcp__beads__show to get comprehensive task information
